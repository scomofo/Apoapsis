...
import { a as Trash2, c as RotateCcw, d as Mountain, f as Locate, l as Play, n as VolumeX, o as Spline, r as Volume2, s as Shuffle, t as Waves, u as Pause } from "../_libs/lucide-react.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BOWB6pFu.js
...
function drawProbes(ctx, opts) {
	...
	for (let i = 0; i < opts.probes.length; i++) {
		...
		ctx.globalAlpha = .95;
		ctx.beginPath();
		ctx.arc(p.x, p.y, r * (1 + pr.flash * .8), 0, Math.PI * 2);
		ctx.fill();
		ctx.globalAlpha = .25;
		ctx.beginPath();
		...
		missions: [
			{
				name: "Lunar Gateway",
				point: "L1",
				note: "Planned staging post on the Earth–Moon doorstep."
			},
			{
				name: "Queqiao",
				point: "L2",
	...
	},
	{
		...
		missions: [
			...
			},
			{
				name: "STEREO",
				point: "L4",
				note: "Drifted through the Trojan region on the way to heliocentric views."
			}
		]
	},
	{
...
function createEngine(canvas, onHud) {
	...
	function spawnProbe(x, y, vx, vy, silent = false) {
	...
	function seedDemo() {
		...
		const id = systemId;
		if (id === "sun-earth") {
			spawnProbe(points.L2.x + 35e-5, 0, 0, 0, true);
			spawnProbe(points.L1.x - 35e-5, 0, 0, 0, true);
			selected = "L2";
		} else if (id === "sun-jupiter") {
			spawnProbe(points.L4.x, points.L4.y, 0, 0, true);
			spawnProbe(points.L5.x, points.L5.y, 0, 0, true);
			selected = "L4";
		} else if (id === "equal") {
			spawnProbe(points.L4.x, points.L4.y, 0, 0, true);
			...
			spawnProbe(points.L4.x, points.L4.y, 0, 0, true);
			spawnProbe(points.L1.x + .002, 0, 0, 0, true);
			selected = "L4";
		}
		hint = true;
	}
	...
	function physicsFrame(h) {
		...
		for (let i = probes.length - 1; i >= 0; i--) {
			...
			if (r1 < sys.primaryR * .82 || r2 < sys.secondaryR * .82 || pr.x * pr.x + pr.y * pr.y > 25) {
				burst(pr.x, pr.y);
				audio.absorb();
				probes.splice(i, 1);
				hudDirty = true;
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-1 max-w-[18rem] text-xs text-muted text-pretty sm:text-sm",
						children: "The five quiet points of two-body gravity"
					}),
					hud.hint ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-2 hidden max-w-[20rem] text-xs text-muted animate-hint sm:block sm:text-sm",
						children: "A probe sits on L4. Another is already leaving L1. Click a point, or drag to throw."
					}) : null
				]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: cn("rounded-full border px-2.5 py-1 text-xs font-medium tracking-wide", hud.stable ? "border-border bg-surface/80 text-fg" : "border-border bg-elevated/80 text-muted"),
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				}), copy ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
					className: cn("pointer-events-none hidden max-w-[18rem] rounded-[20px] border border-border", "bg-surface/80 p-4 shadow-[0_16px_60px_rgba(0,0,0,0.35)] lg:block"),
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						sys.missions.filter((m) => m.point === hud.selected).length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "mt-3 space-y-1.5 border-t border-border pt-3",
							children: sys.missions.filter((m) => m.point === hud.selected).map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				className: cn("pointer-events-auto mt-auto w-full max-w-3xl shrink-0 self-start rounded-[24px] border border-border", "bg-surface/85 p-2.5 shadow-[0_16px_60px_rgba(0,0,0,0.35)] sm:rounded-[28px] sm:p-4"),
				children: [
					copy ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mb-2 truncate px-1 text-xs text-muted lg:hidden",
						...
						children: [
							POINTS.map((id) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									size: "sm",
									variant: hud.selected === id ? "solid" : "outline",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: ["Mass ratio μ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-mono normal-case tabular-nums text-fg/80",
									children: formatMu(hud.mu)
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "relative",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function Simulator() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("canvas", {
			...
			"aria-label": "Lagrange point laboratory"
